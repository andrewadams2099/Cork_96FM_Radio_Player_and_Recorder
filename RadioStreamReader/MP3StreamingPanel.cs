...
namespace RadioStreamReader
{
    public partial class MP3StreamingPanel : UserControl
    {
        ...
        public ReadFullyStream readFullyStream;
        ...
        public MP3StreamingPanel()
        {
            ...
            // Set the waveformat here
            waveFormat = new Mp3WaveFormat(44100, 2, 418, 128000);

            // Start Buffering and Playing 96FM asap
            startPlayBack();

            // Record the News, Weather and Cash Call using Quartz.Net
            IJobDetail job = JobBuilder.Create<RecordJob>()
                .WithIdentity("RecordJob1", "group1")
                .Build();

            // Trigger the job from 12PM to 5PM Mon-Fri
            ITrigger trigger = TriggerBuilder.Create()
                .WithIdentity("trigger1", "group1")
                .StartAt(DateBuilder.FutureDate(10, IntervalUnit.Second))
                .WithCronSchedule("0 0 12-17 ? * MON,TUE,WED,THU,FRI")
                .Build();
        ...
        private void StreamMP3(object state)
        {
            ...
            try
            {
                ...
                {
                    readFullyStream = ReadFullyStream.Instance; // get reference to our singleton class
                    readFullyStream.setStream(responseStream);  // set the stream
                    ...
                    do
                    {
                        ...
                        else
                        {
                            ...
                            if (decompressor == null)
                            {
                                ...
                                // however, the buffered provider doesn't know what sample rate it is working at until we have a frame
